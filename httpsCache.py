...
[docs]class DbmCacheStorage:
    ...
    def open_spider(self, spider):
        ...
        logger.debug("Using DBM cache storage in %(cachepath)s" %
                     {'cachepath': dbpath}, extra={'spider': spider})
...
[docs]class FilesystemCacheStorage:
